...
import numpy as np
from encoder_haps_large_model import hap_inf
...
def train(**kwargs):
    ...
    net = hap_inf(max_hap_len=max_hap_len, units_bilstm2=units_bilstm2, units_bilstm=units_bilstm, dense_units=dense_units, units_firstlstm=units_firstlstm,
...
if __name__=='__main__':
    loc = argv[-1]
    dict ={'KL':False,'ort_constr':False,'num_epochs':100,'num_ancs':10,'dim_ancestors':256,'dense_units':256,'units_firstlstm':256,'units_bilstm2':256,'units_bilstm':256,'max_hap_len':143,'batch_size':100,'prior_temp':0.5,'post_temp':0.5,'log_dir':loc,'log_file':'256x_sampling_10ancs_tmp05'}
